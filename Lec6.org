...
#+BEGIN_SRC ipython :session :file Lec6Bode.svg :exports results
num = [4];
den = [0.01,0.11,1.1,1];
sys = tf(num, den);
...
** Unstable System
#+BEGIN_SRC ipython :session :file Lec6BodeUnstable.svg :exports results
num = [20];
den = [0.01,0.11,1.1,1];
sys = tf(num, den);
mag, phase, omega = bode(sys, dB=True, Plot=False, omega=np.logspace(-1,2,200));
...
#+BEGIN_SRC ipython :session :file Lec6BodePoor.svg :exports results
num = [0.38,0.038,0.209];
den = [1.0, 1.06, 0.56, 0.5, 0.0];
sys = tf(num, den);
mag, phase, omega = bode(sys, dB=True, Plot=False, omega=np.logspace(-1,2,200));
...
#+BEGIN_SRC ipython :session :file Lec6BodeK10.svg :exports results
num = [10];
den = [1,6,5,0];
sys = tf(num, den);
mag, phase, omega = bode(sys, dB=True, Plot=False, omega=np.logspace(-1,2,200));
...
#+BEGIN_SRC ipython :session :file Lec6BodeK100.svg :exports results
num = [100];
den = [1,6,5,0];
sys = tf(num, den);
mag, phase, omega = bode(sys, dB=True, Plot=False, omega=np.logspace(-1,2,200));
